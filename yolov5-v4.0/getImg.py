...
class CTImage(object):
    ...
    def __init__(self, x_offset, y_offset, z_offset, x_ElementSpacing, y_ElementSpacing, z_ElementSpacing):
        ...
        print("质心坐标：",x_offset,y_offset,z_offset)
        print("x,y,z轴步长：", self.ElementSpacing)
...
if __name__ == "__main__":
    case_path = 'E:/graduateDesign/LUNA16/subset0/1.3.6.1.4.1.14519.5.2.1.6279.6001.126264578931778258890371755354.mhd'
    ...
    cv2.imshow("CTimage_result ", imNoudle)
    cv2.imwrite("imNoudle.png", imNoudle)
    img_median = cv2.medianBlur(imNoudle,3)
