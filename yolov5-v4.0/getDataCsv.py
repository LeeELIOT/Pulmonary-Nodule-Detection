...
if __name__ == "__main__":
    ...
    # 标签数据
    fname = 'E:/graduateDesign/LUNA16/CSVFILES/annotations.csv'
    ...
    for file in fileDir:
        ...
        im1 = im1.convert("RGB")      
        im1.save('E:/graduateDesign/LUNA16/VOCdevkit/VOC2019/JPEGImages/{:04d}.png'.format(count+1))
        count = count + 1
        img, mask = getLungMask(imgLabel2)
        im2 = Image.fromarray(img)
        im2 = im2.convert("RGB")      
        im2.save('E:/graduateDesign/LUNA16/VOCdevkit/VOC2019/JPEGImages/{:04d}.png'.format(count+1))
        count = count + 1
        img, mask = getLungMask(imgLabel3)
        im3 = Image.fromarray(img)
        im3 = im3.convert("RGB")      
        im3.save('E:/graduateDesign/LUNA16/VOCdevkit/VOC2019/JPEGImages/{:04d}.png'.format(count+1))
        count = count + 1
        ...
        xmlLabel.write('E:/graduateDesign/LUNA16/VOCdevkit/VOC2007/Annotations/{:04}.xml'.format(count - 2))
        xmlLabel = ToXml('{:04d}.png'.format(count - 1), x, y, w, h)
        xmlLabel.write('E:/graduateDesign/LUNA16/VOCdevkit/VOC2007/Annotations/{:04}.xml'.format(count - 1))
        xmlLabel = ToXml('{:04d}.png'.format(count), x, y, w, h)
        xmlLabel.write('E:/graduateDesign/LUNA16/VOCdevkit/VOC2007/Annotations/{:04}.xml'.format(count))
        nameLast = namePre
